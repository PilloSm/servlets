...
public class Cliente {
    ...
    public String agregarP(String nombre, float precio, int existencia){
    pro=new Producto(nombre, precio, existencia);
    lista.add(pro);
    return respuesta=lista.toString();
    }
    ...
    while (objIterador.hasNext()){
        ...
        if (nombre.equals(pro.getNombre()))
            ...
            if (pro.getExistencia()<unidades){
                ...
                respuesta="Se ha realizado la compra de "+unidades+" "+nombre;
                }
            } 
        }
    return respuesta;
    ...
    public String venta(String nombre, int cantidad){
        ...
        while(objIterador.hasNext())
        {
            ...
            if(nombre.equals(pro.getNombre())){
                pro.setExistencias(pro.getExistencia()+cantidad);
                respuesta="Venta exitosa de "+nombre;
            }
        }
    return respuesta;
    }
